...
%\input{secciones/imagenes}
%\input{secciones/tablas}
%\input{secciones/ecuaciones}
<<<<<<< HEAD
\input{secciones/conclusion}
\section{Espectativa}
\input{secciones\Dan Perea Espinoza}
=======
<<<<<<< HEAD
\section{espectativa}
\input{secciones/Juan Pablo}
\input{secciones/conclusion}
=======
\section{Espectativa}
\input{secciones/Mario}
